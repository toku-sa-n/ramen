...
impl Generic {
    ...
    pub unsafe fn new(abar: AchiBaseAddr) -> Self {
        ...
        let cap = crate::mem::accessor::user(abar);
        let ghc = crate::mem::accessor::user(abar + 0x04_usize);
        let pi = crate::mem::accessor::user(abar + 0x0c_usize);
        let bohc = crate::mem::accessor::user(abar + 0x28_usize);
