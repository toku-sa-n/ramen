...
// FIXME: Rewrite the definition of `INTERRUPT_STACK`:
// pub static INTERRUPT_STACK: VirtAddr =
//     VirtAddr::new_truncate(
//         STACK_BASE.as_u64() - (NUM_OF_PAGES_STACK.as_bytes().as_usize() / 2) as u64,
// );
pub const INTERRUPT_STACK: VirtAddr =
    VirtAddr::new_truncate(0xffff_ffff_c000_0000 - (0x1000 * 16 / 2));
...
pub const KERNEL_NAME: &str = "ramen";
